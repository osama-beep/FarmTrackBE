...
namespace FarmTrackBE.Services
{
    public static class FirebaseInitializer
    {
        ...
        public static void Initialize()
        {
            try
            {
                ProjectId = Environment.GetEnvironmentVariable("FIREBASE_PROJECT_ID") ?? "farmtrackbe";

                string jsonCredentials = Environment.GetEnvironmentVariable("FIREBASE_SERVICE_ACCOUNT_JSON");
